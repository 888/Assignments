...
"""
    lc2200hw1-isa.py: A definition of the LC-2200 architecture for Homework 1 of Spring 2017.
    Adapted from Fall 2016 simulator made by Christopher Tam.
"""
__author__ = "Adithya Nott"


# Define the name of the architecture
__name__ = 'LC-2200-HW1'
