...
double compute_emat() {
    ...
    */
    ...
    double numerator = (tlb_misses * MEMORY_ACCESS_TIME) + (count_pagefaults * DISK_ACCESS_TIME);
    double denominator = total_accesses;
    double time = (numerator / denominator) + MEMORY_ACCESS_TIME;
    return time;
}
