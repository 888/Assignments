...
pcb_t processes[PROCESS_COUNT] = {
    { 0, "Iapache", 2, PROCESS_NEW, pid0_ops },
    { 1, "Ibash", 3, PROCESS_NEW, pid1_ops },
    { 2, "Imozilla", 1, PROCESS_NEW, pid2_ops },
    { 3, "Ccpu", 9, PROCESS_NEW, pid3_ops },
    { 4, "Cgcc", 10, PROCESS_NEW, pid4_ops },
    { 5, "Cspice", 9, PROCESS_NEW, pid5_ops },
    { 6, "Cmysql", 6, PROCESS_NEW, pid6_ops },
    { 7, "Csim", 6, PROCESS_NEW, pid7_ops }
};
