...
for i=1:size(Points_3D, 1)
    first = [Points_3D(i, 1), Points_3D(i, 2), Points_3D(i, 3), 1, 0, 0, 0, 0, -1 * Points_2D(i, 1) * Points_3D(i, 1),  -1 * Points_2D(i, 1) * Points_3D(i, 2),  -1 * Points_2D(i, 1) * Points_3D(i, 3)];
    second = [0, 0, 0, 0, Points_3D(i, 1), Points_3D(i, 2), Points_3D(i, 3), 1, -1 * Points_2D(i, 2) * Points_3D(i, 1),  -1 * Points_2D(i, 2) * Points_3D(i, 2),  -1 * Points_2D(i, 2) * Points_3D(i, 3)];
    a = [a;first;second;];
