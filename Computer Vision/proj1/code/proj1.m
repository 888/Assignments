...
image2 = im2single(imread('../data/cat.bmp')); %cutoff freq = 7

image11 = im2single(imread('../data/bicycle.bmp'));
image12 = im2single(imread('../data/motorcycle.bmp')); %cutoff freq = 6

image13 = im2single(imread('../data/bird.bmp'));
image14 = im2single(imread('../data/plane.bmp')); %cutoff freq = 4

image15 = im2single(imread('../data/fish.bmp')); 
image16 = im2single(imread('../data/submarine.bmp')); %cutoff freq = 9

image17 = im2single(imread('../data/einstein.bmp'));
image18 = im2single(imread('../data/marilyn.bmp')); %cutoff freq = 3

image21 = im2single(imread('../data/eagle.bmp'));
image22 = im2single(imread('../data/falcon.bmp')); %cutoff freq = 
...
low_frequencies = my_imfilter(image11, filter); 
...
high_frequencies = image12 - my_imfilter(image12, filter);
