...
public class ControlPanel extends JPanel {
    ...
    public ControlPanel() {
        ...
        custom1 = new JButton("Swiss");
        custom1.addActionListener(new ButtonListener("Swiss"));
        add(custom1);

        custom2 = new JButton("Ryuujinjakka");
        custom2.addActionListener(new ButtonListener("Ryuujinjakka"));
        add(custom2);
