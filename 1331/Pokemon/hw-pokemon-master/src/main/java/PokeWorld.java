    ...
    private class ClickListener extends MouseAdapter {
        public void mousePressed(MouseEvent e) {
            ...
            if (types.size() < 1100) {
                ...
                } else if (pokemonSpecies.equals("Swiss")) {
                    types.add(new Swiss(p.x, p.y, bounds));
                } else if (pokemonSpecies.equals("Ryuujinjakka")) {
                    types.add(new Ryuujinjakka(p.x, p.y, bounds));
                }
            }
