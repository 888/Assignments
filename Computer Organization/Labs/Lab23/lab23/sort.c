...
int sort_by_alphabet(const void *data1, const void *data2) {
	Person *p1 = (Person*) data1;
	Person *p2 = (Person*) data2;
...
int sort_by_length(const void *data1, const void *data2) {
	...
	{
		return sort_by_alphabet(data1, data2);
	} else 
	{
...
int main(void) {
	...
	qsort(people, 10, sizeof(Person), sort_by_age);
	...
	qsort(people, 10, sizeof(Person), sort_by_alphabet);
	...
	qsort(people, 10, sizeof(Person), sort_by_length);
