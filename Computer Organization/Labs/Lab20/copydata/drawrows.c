...
void drawrow(int row, const unsigned short *image) {
	...
	// TODO remove this loop and re-implement drawing with DMA
	DMA[3].src = &image[row * 240+1];
	DMA[3].dst = &videoBuffer[row * 240+1]; 
	DMA[3].cnt = (240 * 160) | DMA_ON | DMA_SOURCE_INCREMENT;	
