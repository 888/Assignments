...
public class SortingTests {
    ...
    public boolean ENABLE_PICKY_CHECKS = true;
    ...
    private void assertDoesSort(SortFunction<Integer> sort, Comparator<Integer> comparator) {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            Integer[] javaSorted = new Integer[100];
            ...
            Arrays.sort(javaSorted, comparator);

            assertArrayEquals(javaSorted, array);
        }
    ...
    public void radixSort() {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            assertArrayEquals(javaSorted, sorted);
        }
    }
    ...
    @Test
    public void radixSortTerminateCondition() {
        int[] array = {50, 70, 20, 10, 40};
        int[] sorted = Sorting.lsdRadixSort(array);
        int[] expected = {10, 20, 40, 50, 70};
